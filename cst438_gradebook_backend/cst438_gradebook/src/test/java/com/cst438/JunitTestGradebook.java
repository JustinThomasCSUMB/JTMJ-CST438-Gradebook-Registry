...
public class JunitTestGradebook {
   ...
   public void addAssignment() throws Exception {
      ...
      Assignment assignment = new Assignment();
      assignment.setDueDate(new java.sql.Date(System.currentTimeMillis() - 7 * 24 * 60 * 60 * 1000));
      assignment.setName("JT Assignment");
      
      
      response = mvc
            .perform(MockMvcRequestBuilders.post("/gradebook/addAssignment").accept(MediaType.APPLICATION_JSON)
                  .content(asJsonString(assignment)).contentType(MediaType.APPLICATION_JSON)).andReturn().getResponse();
   ...
   public void deleteAssignment() throws Exception {
      ...
      // send updates to server
      response = mvc
            .perform(MockMvcRequestBuilders.delete("/gradebook/deleteAssignment/1"))
            .andReturn().getResponse();
   ...
   public void editAssignmentName() throws Exception {
      ...
      String name = "New Assignment 1";
     
      // send updates to server
      response = mvc
            .perform(MockMvcRequestBuilders.put("/gradebook/editAssignment/1").accept(MediaType.APPLICATION_JSON)
                  .content(asJsonString(name)).contentType(MediaType.APPLICATION_JSON))
            .andReturn().getResponse();
